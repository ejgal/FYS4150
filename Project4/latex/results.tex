...
The run centred around the critical temperature with $dT =$ \num{5e-4}  was better at capturing the the peaks of $C_v$ and $\chi$.
...
$T_C(L=\infty)=2.2687$, with the 99\% confidence interval $\brak{2.2617, 2.2757}$.
 ...
 \begin{table}[h]
   ...
   \caption{Results for T$_C(L=\infty)$. The confidence intervals only take into
   account the extrapolation of T$_C(L=\infty)$.}
   \label{tab:critical}
 \end{table}
