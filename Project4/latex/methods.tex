...
%     \centering
%     \includegraphics[width=\linewidth]{../figures/relative_error_order0_T1.pdf}
%     \caption{}
%     \label{fig:sub-first}
%   \end{subfigure}
%   \hfill
%   \begin{subfigure}[t]{.5\textwidth}
%     \centering
%     \includegraphics{../figures/relative_error_order1_T1.pdf}
%     \caption{}
...
%   \begin{subfigure}[t]{.5\textwidth}
%     \centering
%     \includegraphics{../figures/relative_error_order0_T2.pdf}
%     \caption{}
%     \label{fig:sub-second}
%   \end{subfigure}
%   \begin{subfigure}[t]{.5\textwidth}
%     \centering
%     \includegraphics[width=\linewidth]{../figures/relative_error_order1_T2.pdf}
%     \caption{}
%     \label{fig:sub-second}
%   \end{subfigure}
