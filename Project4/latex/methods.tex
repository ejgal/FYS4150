...
for a given temperature. In the canonical ensembfle the probability distribution
...
lattices it becomes impossible compute. We need to devise a scheme that lets us
...
of roughly 3.4 on a computer with 4 physical cores. The suboptimal speedup might
