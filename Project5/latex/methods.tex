...
The first step towards the BRWE is to linearise the vorticity equation \cref{eq:
QG_vorticity}. If we suppose that the flow can be represented by a mean flow
plus some small perturbation $u = U + u'$ and $v = V + v'$, where $|U| >> u'$
and $|V| >> v'$.     
