...
\usepackage{epstopdf}
% Standard stuff
\usepackage{bm,amsmath,grac phicx,varioref,verbatim,amsfonts,geometry, mleftright, siunitx}
...
\title{Investigation of phase transitions in magnetic systems using the Ising Model}
